...
import com.example.demo.base.enums.EQiNiuArea;
...
public class QiniuUtil {
    ...
    public Map<String, String> getQiNiuConfig() {
        ...
        String uploadQiNiu = ossResultMap.get(SysConf.UPLOAD_QI_NIU);
        ...
        String qiNiuPictureBaseUrl = ossResultMap.get(SysConf.QI_NIU_PICTURE_BASE_URL);
        String qiNiuAccessKey = ossResultMap.get(SysConf.QI_NIU_ACCESS_KEY);
        String qiNiuSecretKey = ossResultMap.get(SysConf.QI_NIU_SECRET_KEY);
        String qiNiuBucket = ossResultMap.get(SysConf.QI_NIU_BUCKET);
        String qiNiuArea = ossResultMap.get(SysConf.QI_NIU_AREA);

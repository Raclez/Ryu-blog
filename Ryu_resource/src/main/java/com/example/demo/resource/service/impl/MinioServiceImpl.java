...
import com.example.demo.resource.service.MinioService;
import com.example.demo.resource.util.MinioUtil;
import com.example.demo.resource.util.RyuFileUtil;
...
public class MinioServiceImpl implements MinioService {
    ...
    public String uploadPictureByUrl(String itemUrl) {
        ...
        try {
            ...
            out.flush();
            out.close();
            MultipartFile multipartFile = RyuFileUtil.fileToMultipartFile(dest);
            return minioUtil.uploadFile(multipartFile);
        } catch (Exception e) {

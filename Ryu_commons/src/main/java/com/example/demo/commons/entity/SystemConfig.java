...
public class SystemConfig extends SuperEntity<SystemConfig> {
    ...
    /**
     * 标题图片显示优先级（ 0:本地  1: 七牛云 2: Minio  3:OSS）
     */
    private String picturePriority;

    /**
     * 博客详情图片显示优先级（ 0:本地  1: 七牛云 2: Minio  3:Oss）
     */
    ...
    /**
     * 七牛云存储图片服务器，域名前缀: http://images.Ryuit.cn
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
    private String qiNiuPictureBaseUrl;

    /**
     * Minio服务器文件域名前缀： http://minio.Ryuit.cn
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
     ...
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
    private String ossPictureBaseUrl;

...
public class CreatCodeRestApi {
    ...
    @Value(value = "${RyuBlog.email}")
    private String RyublogEmail;
    ...
    public String validCode(HttpServletRequest request,
        ...
        String text =
                "<html>\r\n" +
                        ...
                        "<div class=\"container\">\r\n" +
                        "<div class=\"logo\">\r\n" +
                        "<img src=\"https://educa-10.oss-cn-beijing.aliyuncs.com/2021-08-16/e19c0629728a475786d99301f6ee017bfavicon48.ico\",height=\"100\" width=\"100\">\r\n" +
                        "</div>\r\n" +
                        ...
                        "<p>您好 <a href=\"mailto:" + RyublogEmail + "\" rel=\"noopener\" target=\"_blank\">" + info + "<wbr></a>！</p>\r\n" +
                        "<p>欢迎注册Ryu博客，请将验证码填写到注册页面。</p>\r\n" +
                        "<p>验证码：" + code + "</p>\r\n" +
                        "\r\n" +
                        "</div>\r\n" +
                        "</div>\r\n" +
        ...
        if (CheckUtils.checkEmail(info)) {
            ...
            map.put("text", text);
            //发送到RabbitMq
            rabbitTemplate.convertAndSend("exchange.direct", "Ryu.email", map);
        }
        if (CheckUtils.checkMobileNumber(info)) {
            //code是我们申请模板时写的参数
            map.put("param", code);
            ...
            //发送到RabbitMq
            rabbitTemplate.convertAndSend("exchange.direct", "Ryu.sms", map);
        }

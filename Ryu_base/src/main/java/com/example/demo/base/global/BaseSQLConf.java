...
public class BaseSQLConf {
    ...
    public final static String UPLOAD_OSS = "upload_oss";
    ...
    public final static String QI_NIU_PICTURE_OSS_URL = "oss_picture_base_url";
    ...
    public final static String OSS_ACCESS_KEY = "oss_access_key";
    public final static String OSS_SECRET_KEY = "oss_secret_key";
    public final static String OSS_BUCKET = "oss_bucket";
    public final static String QI_NIU_BUCKET = "qi_niu_bucket";
    public final static String OSS_ENDPOINT = "oss_endpoint";

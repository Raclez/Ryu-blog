package com.example.demo.base.global;

/**
 * 常量的基类
 *
 * @author
 * @date 2021年7月25日00:06:54
 */
public class BaseSysConf {
    ...
    public final static String OSS_URL = "ossUrl";
    ...
    public final static String Ryu_BLOG = "Ryu.blog";
    ...
    public final static String UPLOAD_OSS = "uploadOss";
    ...
    public final static String OSS_PICTURE_BASE_URL = "ossPictureBaseUrl";
    ...
    public final static String OSS_ACCESS_KEY = "ossAccessKey";
    public final static String OSS_SECRET_KEY = "ossSecretKey";
    public final static String OSS_BUCKET = "ossBucket";
    public final static String OSS_ENPOINT = "ossEndpoin";

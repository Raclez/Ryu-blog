...
import com.example.demo.commons.entity.Link;
...
import com.example.demo.web.global.RedisConf;
import com.example.demo.web.global.SQLConf;
import com.example.demo.web.global.SysConf;
import com.example.demo.xo.service.*;
import com.example.demo.xo.utils.RabbitMqUtil;
import com.example.demo.xo.utils.WebUtil;
import com.example.demo.xo.vo.FeedbackVO;
import com.example.demo.xo.vo.LinkVO;
import com.example.demo.xo.vo.UserVO;
import com.example.demo.base.enums.EGender;
import com.example.demo.base.enums.ELinkStatus;
...
public class AuthRestApi {
    ...
    public String updateUserPwd(HttpServletRequest request, @RequestParam(value = "oldPwd") String oldPwd, @RequestParam("newPwd") String newPwd) {
        ...
        User user = userService.getById(userUid);
        // 判断是否是第三方登录的账号
        if (!user.getSource().equals(SysConf.Ryu)) {
        ...
        switch (source) {
            case SysConf.GITHUB:
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        ...
                        .redirectUri(RyuWebUrl + "/oauth/callback/github")
                        .build());
                break;
            case SysConf.GITEE:
                authRequest = new AuthGiteeRequest(AuthConfig.builder()
                        ...
                        .redirectUri(RyuWebUrl + "/oauth/callback/gitee")
                        .build());
                break;
            case SysConf.QQ:
                authRequest = new AuthQqRequest(AuthConfig.builder()
                        ...
                        .redirectUri(RyuWebUrl + "/oauth/callback/qq")
                        .build());
                break;
            default:
                break;
